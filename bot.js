...
bot.on('message', message => {
  ...
  if (command === "support") {
      ...
      message.member.addRole("340634859913609226");
      message.author.sendMessage('**You have been added to the role wait for a staff to respond.**');
  } else {
      message.author.sendMessage('**You dont have the required role:** ``(Elysian-Owner).``');
  }
  }
